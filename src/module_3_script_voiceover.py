...
class ScriptModule:
    ...
    def run(self) -> Script:
        ...
        script = self.generate_all_voiceovers(script, narrator_voice=plan.narrator_voice if plan else None)
    ...
    def generate_voiceover_segment(
        ...
        try:
            ...
            self._macos_say_fallback(text, out, preferred_voice=narrator_voice)
        return out
    ...
    def generate_all_voiceovers(
        ...
        for seg in script.segments:
            wav = self.generate_voiceover_segment(seg.text, seg.id, narrator_voice=narrator_voice)
