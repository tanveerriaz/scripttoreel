...
class ProductionPlan(BaseModel):
    """Pre-production creative brief generated by the AI Director during --init."""
    topic: str
    duration_sec: float = 0.0
    duration_minutes: float = 5.0
    visual_style: str = "documentary"       # documentary | cinematic | minimalist
    ...
    background_music_keywords: list[str] = Field(default_factory=list)
    sfx_keywords: list[str] = Field(default_factory=list)
    text_overlay_style: str = "lower_third"
